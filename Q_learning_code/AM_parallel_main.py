...
def single_process(alpha):
    ...
    for cl in c_list:
        ...
        for beta in beta_list:
            ...
            am = AMModel(alpha = alpha, beta = beta)
            converged, indexStrategies,indexConverge = q_learning(am,convergedtime= cl)
            df = df.append({'alpha':alpha,'beta':beta,'total_sessions':am.numSessions,'converged_times':cl,'indexStrategie':indexStrategies,'indexConverge':indexConverge },ignore_index=True)
